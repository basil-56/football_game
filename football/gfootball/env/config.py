...
#python3 -m gfootball.replay --trace_file=/tmp/dumps/episode_done_20231023-162743197070.dump
#python3 -m gfootball.replay --trace_file=/tmp/dumps/episode_done_20231023-164533326283.dump
...
#        'dump_full_episodes': False,
#        'dump_scores': False,
#        'players': ['agent:left_players=4','agent:right_players=4'],#'players': ['agent:left_players=1']
#        'level': '5_vs_5',
